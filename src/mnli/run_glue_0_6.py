...
def main():
    ...
    parser.add_argument("--train_mode", choices=["fine_tune", "random", "random_frozen", "frozen"], default="fine_tune")
    ...
    args.per_gpu_train_batch_size = args.per_gpu_train_batch_size // args.gradient_accumulation_steps
    ...
    if args.do_train:
        ...
        num_train_optimization_steps = int(
            len(train_examples) / args.per_gpu_train_batch_size / args.gradient_accumulation_steps) * args.num_train_epochs
    ...
    if args.do_train:
        ...
        train_dataloader = DataLoader(train_data, sampler=train_sampler, batch_size=args.per_gpu_train_batch_size)
