...
def evaluate(args, model, tokenizer):
    ...
    eval_dataset, label_list = load_and_cache_examples(args.data_dir, args.max_seq_length, model.config.model_type, args.model_name_or_path, tokenizer, args.overwrite_cache)
